...
interface IUniswapV3Staker is IERC721Receiver, IMulticall {
    ...
    function incentives(bytes32 incentiveId) external view 
    ...
    function stakes(uint256 tokenId, bytes32 incentiveId) external view
    ...
    function getRewardInfo(IncentiveKey memory key, uint256 tokenId) external
